...
```{r, fig.cap= "Figure 1. Heat map of lemur densities at each project transect site", echo = FALSE }
density_plot
...
```{r, fig.cap="Figure 2. Boxplot of lemur densities at each sampling site." , echo = FALSE}
...
```{r , fig.cap="Figure 3. Boxplot of lemur densities for each species surveyed.", echo = FALSE}
