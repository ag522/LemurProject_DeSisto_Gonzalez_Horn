...
First, a one-way analysis of variance (ANOVA) was conducted on lemur population density by site. The analysis was significant F (4,254)= 3.469, p = 0.009, meaning that there is a significatn difference in lemur densities between different sites. A post-hoc test revelaed that the difference can be found between Miaranony and Ampatsoana, Miaranony and Maharira sites. However, after analyzing the Lemur Density per site boxplots(figure 1), there is strong evidence that the higher lemur densities seen in  Miaranony and Valohoaka are the result of outliers. 
Next, a second one-way analysis of variance (ANOVA) was conducted on lemur population density by species. The analysis was very significant  F (8,250) = 16.79, p = <2e-16, meaning that there is a strong difference in lemur densities between different species. Post-hoc tests indicate that species fall into four main groups according to their density:
...
From our analysis there is a significant difference in Lemur population density between different species. There is also a slightly less significant difference in population density between sites. 
